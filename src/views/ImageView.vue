...
<template>
  ...
  >
    <img
      ...
      "
      :src="images.image.urls.full"
      :alt="images.image.alt_description"
    />
    ...
    >
      <div class="image-info">
        <div style="display: flex; align-items: center">
          <img
            :src="images.image.user.profile_image.small"
            style="
              border-radius: 8px;
          ...
          <div>
            <p class="user-name">
              {{ images.image.user.name }}
            </p>
            <p class="user-username">@{{ images.image.user.username }}</p>
          </div>
        </div>

        <div style="display: flex; align-items: center; gap: 20px">
          <button
            class="button active-bg"
            style="
              aspect-ratio: 1/1;
              display: flex;
              align-items: center;
              ...
              border-radius: 8px;
            "
            @click="images.addToFavorite(images.image)"
          >
            <svg
              width="25"
              height="23"
...
.active-bg:hover {
  background-color: rgb(235, 170, 170) !important;
}
